...
from finetune_utils.data import create_dataloader
from finetune_utils.logger import MetricLogger, SmoothedValue, WandBLogger
from finetune_utils.utils import init_distributed_mode, fix_random_seed
...
def main(cfg):
    ...
    if cfg.mode == 'finetune':
        if cfg.ckpt is not None:
            ...
            elif cfg.ckpt.endswith('.tar'):
                ckpt_model = load_state_dict(cfg.ckpt)
                state_dict = model.state_dict()
